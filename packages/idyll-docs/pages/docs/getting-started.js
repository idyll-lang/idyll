...
<iframe width="560" height="315" src="https://www.youtube.com/embed/9YvEFdiY0yE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
export default ({ url }) => (
  ...
  >
    ...
    <p>
      ...
      to learn how to use Idyll's syntax.
    </p>
  </Layout>
);
