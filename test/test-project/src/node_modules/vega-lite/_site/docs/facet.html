...
Vega-Lite specifications consist of simple mappings of variables in a data set to visual encoding channels such as x, y, color, and size. These mappings are then translated into detailed visualization specifications in the form of Vega specification language. Vega-Lite produces default values for visualization components (e.g., scales, axes, and legends) in the output Vega specification using a rule-based approach, but users can explicit specify these properties to override default values.">
    ...
    <title> Vega-Lite: Faceting a plot into a Trellis Plot. </title>
...
<div class="page-centered page-main">
  ...
  <section class="page-content">
    ...
    <p><a href="https://en.wikipedia.org/wiki/Small_multiple">A Trellis plot (or small multiple)</a> is a series of similar plots that displays different subsets of the same data, facilitating comparison across subsets. Adding a field to the <a href="encoding.html#facet"><code class="highlighter-rouge">column</code> or <code class="highlighter-rouge">row</code> channel</a> produces a trellis plot that facets the plots into columns or rows respectively.</p>

<h2 id="example">Example</h2>

<p>Below are three histograms for the horsepower of cars. Each chart shows the histogram for one origin (Europe, Japan, and USA).</p>

<p><span class="vl-example" data-name="trellis_bar_histogram"></span></p>

<p>You can find more examples in the <a href="/vega-lite/gallery.html#trellis-plots">example gallery</a>.</p>

<p><strong>Note</strong> Since <code class="highlighter-rouge">row</code> and <code class="highlighter-rouge">column</code> represent actual data fields that are used to partition the data, they cannot encode constant <code class="highlighter-rouge">value</code>. Also, you should not facet by quantitative fields unless they are <a href="bin.html">binned</a>, or temporal fields unless you use <a href="timeunit.html"><code class="highlighter-rouge">timeUnit</code></a>.</p>
...
<footer>
  <div class="page-centered">
    <span>
      <a href="https://github.com/vega/vega-lite/edit/master/site/docs/facet.md">Edit this page</a> and submit a pull request!
    </span>
